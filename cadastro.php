...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    //verificar erros de entrada antes de ir pro bd
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            //vincular as variáveis à instrução
            $stmt->bindParam(":username", $param_username, PDO::PARAM_STR);
            $stmt->bindParam(":password", $param_username, PDO::PARAM_STR);

            //definir parâmetros
            $param_username = $username;
            $param_password = password_hash($password, PASSWORD_DEFAULT); //password hash criado
